...
/**
 * Fenetre principale de l'application: elle g�re l'affichage de chaque mode.
 * 
...
public class Fenetre extends JFrame {
    ...
    /**
     * Recentre la frame par rapport � l'ecran.
     * 
     */
    public void centrer() {
	this.pack();
     ...
     * 
     * @param contenuACacher
     *            est le panel qui va etre remplacer par le menu principal.
     * 
     */
     ...
     * 
     * @param contenuACacher
     *            est le panel qui va etre remplacer par le mode jeu.
     * @param j
     *            est le panel du jeu
     * 
     */
     ...
     * 
     * @param contenuACacher
     *            est le panel qui va etre remplacer par le mode editeur.
     * 
     */
    ...
    /**
     * Affiche la selection des d�fis sur la fenetre.
     * 
     * @param contenuACacher
     *            est le panel qui va etre remplacer par le menu de s�lection
     *            des d�fis.
     * 
     */
	...
	this.setTitle("Solitaire Chess - S�l�ction d�fi");
	this.centrer();
    }
}
